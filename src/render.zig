...
pub fn consoleRenderer(out_stream: anytype, alloc: Allocator) ConsoleRenderer(@TypeOf(out_stream)) {
    return ConsoleRenderer(@TypeOf(out_stream)).init(out_stream, alloc);
}
